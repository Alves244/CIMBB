@extends('layouts.user_type.auth') {{-- Está correto --}}

@section('content') {{-- Está correto --}}

  <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
    <div class="container-fluid">

      {{-- CABEÇALHO com a tua imagem de fundo --}}
      <div class="page-header min-height-300 border-radius-xl mt-4" 
           style="background-image: url('{{ asset('assets/img/cimbb/perfil/fundo_perfil.jpg') }}'); 
                  background-size: cover; 
                  background-position: center center; 
                  background-repeat: no-repeat;">
      </div>
      
      {{-- Card com Nome e Botão de Definições --}}
      <div class="card card-body blur shadow-blur mx-4 mt-n6 overflow-hidden">
        <div class="row gx-4">
          
          {{-- Nome e Perfil (Dados Reais) --}}
