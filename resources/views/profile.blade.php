          ...
          <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
            <div class="nav-wrapper position-relative end-0">
              <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                <li class="nav-item">
                  {{-- Link para a página user-profile que me enviaste --}}
                  <a class="nav-link mb-0 px-0 py-1 active " href="{{ url('user-profile') }}" role="tab" aria-selected="true">
                    <svg class="text-dark" width="16px" height="16px" viewBox="0 0 40 40" ...> {{-- SVG do ícone settings --}}
